    ...
    loadData (pagination, filters, sorter) {
      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(response => {
          ...
          if (content.length === 0 && this.showPagination && this.localPagination.current > 1) {
          ...
          try {
            if ((['auto', true].includes(this.showPagination) && page.totalCount <= (page.pageNo * this.localPagination.pageSize))) {
              this.localPagination.hideOnSinglePage = true
            }
          } catch (e) {
            this.localPagination = false
          }
          this.localDataSource = content // 返回结果中的数组数据
